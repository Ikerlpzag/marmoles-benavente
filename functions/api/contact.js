  ...
  try {
    ...
    if (
      ...
      return Response.json(
        {
          success: false,
          error: "El formulario supera la longitud permitida",
        },
        {
          status: 400,
        }
    ...
    const mensajeSeguro = escapeHtml(mensaje.trim());
    ...
    await resend.emails.send({
      ...
      replyTo: email.trim(),
      subject: `📩 Nuevo formulario de contacto - ${nombre.trim()}`,
      html: `
        <!DOCTYPE html>
        <html lang="es">
        <head>
                  ...
                  <tr>
                    <td style="padding:45px;">
                      ...
                      <p style="margin:0 0 35px;color:#666;line-height:28px;">
                        Se ha recibido una nueva solicitud a través del formulario
                        de contacto de la página web. A continuación se muestran
                      ...
                      <div style="margin-top:45px;">
                        ...
                        <h3 style="margin:0 0 18px;font-size:18px;font-weight:500;">
                          Mensaje
                        </h3>
                  ...
                  <tr>
                    <td style="padding:30px 45px;background:#fafafa;border-top:1px solid #ececec;">
                      ...
                      <p style="margin:0;font-size:13px;color:#888;line-height:24px;">
                        Este correo ha sido generado automáticamente desde el
